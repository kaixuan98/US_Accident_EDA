...
import style from '../question6/q6Style.module.scss';
import poi_count from '../question6/data/poi_count.csv'
...
const Question5 = ({pageVariants, pageTransition}) => {
    ...
    const yValue = d => d.POI
    const xValue = d => parseInt(d.Count)
    ...
    return (
        ...
        >
            <NavBar currentPage={7}  nextPageLink={"question7"} prevPageLink={"question6"}></NavBar>
            <div className='content'>
                <h1 className='headline'>Nearby Point of Interest of the Accidents</h1>
                <div className='graph'>
