    ...
    <div className="App" style={{position: 'relative'}}>
      <AnimatePresence>
        <Routes basename={'/US_Accident_EDA/dataviz-lib'} location={loc} key={loc.pathname}>
          ...
          <Route path='/question3' element={<Question3 pageVariants={pageVariants} pageTransition={pageTransition}/>}></Route>
          <Route path='/question4' element={<Question4 pageVariants={pageVariants} pageTransition={pageTransition}/>}></Route>
          <Route path='/question5' element={<Question5 pageVariants={pageVariants} pageTransition={pageTransition}/>}></Route>
          <Route path='/question6' element={<Question6 pageVariants={pageVariants} pageTransition={pageTransition}/>}></Route>
        </Routes>
      </AnimatePresence>
    </div>
  );
